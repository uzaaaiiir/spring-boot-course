...
import com.springboot.mappingsdemo.entity.*;
...
public class MappingsDemoApplication {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		// courses
		Course course = new Course("Biology for Humans");

		// students
		Student student1 = new Student("Chad", "Darby", "chad@example.com");
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		System.out.println("Students enrolled: " + course.getStudents());
		System.out.println("Done.");
	}
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course course2 = new Course("Introduction to Game Development");
